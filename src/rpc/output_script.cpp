...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{
        "validateaddress",
        "\nReturn information about the given QuantumBTC address.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The QuantumBTC address to validate"},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::BOOL, "isvalid", "If the address is valid or not"},
                {RPCResult::Type::STR, "address", /*optional=*/true, "The QuantumBTC address validated"},
