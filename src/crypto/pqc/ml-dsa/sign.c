...
*
* Description: Generates public and private key from a 32-byte seed.
*              The same seed always produces the same keypair (deterministic).
*
* Arguments:   - uint8_t *pk: pointer to output public key (CRYPTO_PUBLICKEYBYTES)
*              - uint8_t *sk: pointer to output secret key (CRYPTO_SECRETKEYBYTES)
*              - const uint8_t seed[SEEDBYTES]: 32-byte seed
*
* Returns 0 (success)
**************************************************/
